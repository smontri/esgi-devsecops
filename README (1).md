...
Ce paragraphe décrit l'infrastructure (Instance EC2) à déployer pour construire le pipeline DevSecOps et les éléments de configuration à appliquer la VM.
